...
const TableThree = () => {
  ...
  if(error) return <h1 className='text-red-500'>Opps! Something Went wrong While Fetching The Data</h1>
  return (
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <p
                    className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${
                      packageItem.isDeactivated === 'true'
                  ...
                  >
                    {packageItem.isDeactivated ? 'Yes' : 'No'}
                  </p>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <Link to={`/profile/${packageItem._id}`}>
                    ...
                    <Link to={`/add-edit/${packageItem._id}`}  className="hover:text-primary">
                        <CiEdit size="20"/>
                    </Link>
                  </div>
                </td>
